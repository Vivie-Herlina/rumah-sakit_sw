    ...
    <user class="usermenus">
        <div class="row row-cols-4 gap-2">
            <div class="col d-flex flex-column">
                <img src="/asset/img/vector91.svg" alt="" class="img-link">
                <h6>Pendaftaran</h6>
            </div>
            <div class="col d-flex flex-column">
                <img src="/asset/img/vector92.svg" alt="" class="img-link">
                <h6 class="text center">Hasil Diagnosa</h6>
            </div>
            <div class="col d-flex flex-column">
                <img src="/asset/img/vector93.svg" alt="" class="img-link">
                <h6>Resep Obat</h6>
            </div>
            <div class="col d-flex flex-column">
                <img src="/asset/img/vector94.svg" alt="" class="img-link">
                <h6> <a href="{{route('antrianpasient')}}"> Antrian</a></h6>
            </div>

            <div class="col d-flex flex-column">
                <img src="/asset/img/vector95.svg" alt="" class="img-link">
                <h6><a href="{{route('scanner')}}">Scan Barcode</a></h6>
            </div>
